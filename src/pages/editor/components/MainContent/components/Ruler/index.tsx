...
const Ruler = () => {
  ...
  const propertyPanelWidth = useSelector(selectPropertyPanelWidth);
  ...
  useEffect(() => {
    if (rulerXCanvasCtx) {
      ...
      const offset = rulerXCanvasWidth + propertyPanelWidth - canvasWidth / 2 - screenWidth / 2;
      drawRuler({
        ctx: rulerXCanvasCtx,
        step: rulerStep,
        shortScaleLength,
